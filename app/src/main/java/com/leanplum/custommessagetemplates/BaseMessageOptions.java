    ...
    public static ActionArgs toArgs(Context currentContext) {
        return new ActionArgs()
                .with(Args.TITLE_TEXT,
                        com.leanplum.custommessagetemplates.MessageTemplates.getApplicationName(currentContext))
                .withColor(Args.TITLE_COLOR, Color.BLACK)
                .with(Args.MESSAGE_TEXT, com.leanplum.custommessagetemplates.MessageTemplates.Values.POPUP_MESSAGE)
