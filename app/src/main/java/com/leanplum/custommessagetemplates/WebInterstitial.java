...
public class WebInterstitial extends BaseMessageDialog {
  ...
  public WebInterstitial(Activity activity, com.leanplum.custommessagetemplates.WebInterstitialOptions options) {
  ...
  public static void register(Context currentContext) {
    Leanplum.defineAction(NAME, Leanplum.ACTION_KIND_MESSAGE | Leanplum.ACTION_KIND_ACTION,
        com.leanplum.custommessagetemplates.WebInterstitialOptions.toArgs(), new ActionCallback() {
          @Override
