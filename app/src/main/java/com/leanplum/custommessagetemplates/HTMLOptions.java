...
class HTMLOptions {
  ...
  HTMLOptions(ActionContext context) {
    ...
    this.setCloseUrl(context.stringNamed(com.leanplum.custommessagetemplates.MessageTemplates.Args.CLOSE_URL));
    this.setOpenUrl(context.stringNamed(com.leanplum.custommessagetemplates.MessageTemplates.Args.OPEN_URL));
    this.setTrackUrl(context.stringNamed(com.leanplum.custommessagetemplates.MessageTemplates.Args.TRACK_URL));
    this.setActionUrl(context.stringNamed(com.leanplum.custommessagetemplates.MessageTemplates.Args.ACTION_URL));
    this.setTrackActionUrl(context.stringNamed(com.leanplum.custommessagetemplates.MessageTemplates.Args.TRACK_ACTION_URL));
    this.setHtmlAlign(context.stringNamed(com.leanplum.custommessagetemplates.MessageTemplates.Args.HTML_ALIGN));
    this.setHtmlHeight(context.numberNamed(com.leanplum.custommessagetemplates.MessageTemplates.Args.HTML_HEIGHT).intValue());
    this.setHtmlWidth(context.stringNamed(com.leanplum.custommessagetemplates.MessageTemplates.Args.HTML_WIDTH));
    this.setHtmlYOffset(context.stringNamed(com.leanplum.custommessagetemplates.MessageTemplates.Args.HTML_Y_OFFSET));
    this.setHtmlTabOutsideToClose(context.booleanNamed(
        com.leanplum.custommessagetemplates.MessageTemplates.Args.HTML_TAP_OUTSIDE_TO_CLOSE));
  }
  ...
  private static Map<String, Object> replaceFileToLocalPath(Map<String, Object> map,
    ...
    for (String key : keyArray) {
      if (map.get(key) instanceof Map) {
      ...
      } else if (key.contains(com.leanplum.custommessagetemplates.MessageTemplates.Values.FILE_PREFIX) &&
        ...
        if (localPath.contains(Leanplum.getContext().getPackageName())) {
          map.put(key.replace(com.leanplum.custommessagetemplates.MessageTemplates.Values.FILE_PREFIX, ""),
  ...
  private static String getTemplate(ActionContext context) {
    ...
    String htmlTemplate = readFileAsString(context, com.leanplum.custommessagetemplates.MessageTemplates.Values.HTML_TEMPLATE_PREFIX);
    Map<String, Object> htmlArgs = replaceFileToLocalPath(context.getArgs(),
        com.leanplum.custommessagetemplates.MessageTemplates.Values.HTML_TEMPLATE_PREFIX);
  ...
  public static ActionArgs toArgs() {
    return new ActionArgs()
        .with(com.leanplum.custommessagetemplates.MessageTemplates.Args.CLOSE_URL, com.leanplum.custommessagetemplates.MessageTemplates.Values.DEFAULT_CLOSE_URL)
        .with(com.leanplum.custommessagetemplates.MessageTemplates.Args.OPEN_URL, com.leanplum.custommessagetemplates.MessageTemplates.Values.DEFAULT_OPEN_URL)
        .with(com.leanplum.custommessagetemplates.MessageTemplates.Args.ACTION_URL, com.leanplum.custommessagetemplates.MessageTemplates.Values.DEFAULT_ACTION_URL)
        .with(com.leanplum.custommessagetemplates.MessageTemplates.Args.TRACK_ACTION_URL,
            com.leanplum.custommessagetemplates.MessageTemplates.Values.DEFAULT_TRACK_ACTION_URL)
        .with(com.leanplum.custommessagetemplates.MessageTemplates.Args.TRACK_URL, com.leanplum.custommessagetemplates.MessageTemplates.Values.DEFAULT_TRACK_URL)
        .with(com.leanplum.custommessagetemplates.MessageTemplates.Args.HTML_ALIGN, com.leanplum.custommessagetemplates.MessageTemplates.Values.DEFAULT_HTML_ALING)
        .with(com.leanplum.custommessagetemplates.MessageTemplates.Args.HTML_HEIGHT, MessageTemplates.Values.DEFAULT_HTML_HEIGHT);
  }
